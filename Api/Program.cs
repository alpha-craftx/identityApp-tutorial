...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            // validate the issuer(whio ever is issuing the JWT)
            ValidateIssuer = true,
...
// Authentication verifies the identify of a user or service, and authorization determines their acces rights.
app.UseAuthentication();
app.UseAuthorization(); // what kind of permission do they have?
